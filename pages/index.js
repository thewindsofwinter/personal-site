  ...
  return (
    <div className="bg-ink min-h-screen">
      ...
      <div className="wrapper relative z-5">
        <div className="splash table-cell align-middle w-screen h-screen">
          <table className="m-auto text-white">
            <tbody>
              ...
              <tr>
                ...
                <td className="spacing"></td>
                <td className="logo">                  
                  <a target="_blank" href="weixin://dl/chat?andyytang">
                ...
                <td className="logo">
                  <a target="_blank" href="https://linkedin.com/in/andyytang">
